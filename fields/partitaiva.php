...
function gf_field_piva_init() {

	class GF_Field_PIVA extends GF_Field {

		/**
		 * @var string $type The field type.
		 */
		public $type = 'partita-iva';
		...
		public function get_form_editor_field_title() {
			return esc_attr__( 'Partita IVA', 'gravityforms-pivacf-fields' );
		}
		...
		public function validate( $value, $form ) {
			if ( !preg_match( '/^[0-9]{11}$/', $value ) ) {
				...
				$this->validation_message = empty( $this->errorMessage ) ? __( 'VAT is not valid.', 'gravityforms-pivacf-fields' ) : $this->errorMessage;
            }
		}

	}

	GF_Fields::register( new GF_Field_PIVA() );
}

add_action( 'gform_loaded', 'gf_field_piva_init', 9999 );
